...
<body>
    <div class="container">
        ...
        <div class="link">
            ...
            <li><i class="bi bi-cloud-plus-fill" style="color: white;"></i><a href="#">import</a> </li>
    ...
    <div class="dashboard">
        ...
        <div class="welc">
            <p for=""><label for="">Imports</label> Station</p>
        </div><br>
       <div class="select">
        <label for="">All imported food listed here</label>
        <input type="search" placeholder="search here"> 
        <button><i class="bi bi-search-heart-fill"></i></button>
        <a href="import.php"><button><i class="bi bi-plus-circle-fill"></i> Import New</button></a>
       <table border="2" cellpadding="10" width="90%">
            ...
            <?php
                   ...
                   while($row=mysqli_fetch_assoc($query_result)){
                    ...
                    <td>
                        <a href="updateimportfood.php?i_id=<?php echo $row['i_id'];?>" title="update"><i class="bi bi-pencil-square" style="color:#0a6e39; font-size:20px;"></i></a>
                        <a href="deleteimpofood.php?i_id=<?php echo $row['i_id'];?>" title="delete"><i class="bi bi-trash-fill" style="color:red; font-size:20px;"></i></a>
                    </td>

...
<body>
    <div class="container">
        ...
        <div class="link">
            ...
            <li><i class="bi bi-egg-fried" style="color: white;"></i><a href="#">foods</a> </li>
    ...
    <div class="dashboard">
        ...
        <div class="welc">
            <p for=""><label for="">Foods</label> Station</p>
        </div><br>
       <div class="select">
        <label for="">All food listed here</label>
        <input type="search" placeholder="search here"> 
        <button><i class="bi bi-search-heart-fill"></i></button>
        <a href="addfood.php"><button><i class="bi bi-plus-circle-fill"></i> Add New</button></a>
       <table border="2" cellpadding="10" width="90%">
            ...
            <?php
                   ...
                   while($row=mysqli_fetch_assoc($query_result)){
                    ...
                    <td>
                        <a href="updatefood.php?food_id=<?php echo $row['food_id']?>" title="update"><i class="bi bi-pencil-square" style="color:#0a6e39; font-size:20px;"></i></a>
                        <a href="deletfood.php?food_id=<?php echo $row['food_id']?>" title="delete"><i class="bi bi-trash-fill" style="color:red; font-size:20px;"></i></a>
                    </td>
